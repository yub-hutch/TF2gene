...
#' @param chr_lens A tibble containing chromosome lengths with columns: 'chr' and 'length' (default is TF2gene::grch38_chr_lens).
...
#' @export
#'
generate_control_regions <- function(meta_gene = TF2gene::grch38, chr_lens = TF2gene::grch38_chr_lens, region_length = 500, radius = 500e3) {
  control_region = NULL
  ...
  # Align to bed format
  control_region$start = control_region$start - 1
